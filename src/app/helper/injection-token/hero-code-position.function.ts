 ...
 * - **$\omega$ (`HERO_CODE_OMEGA`)**: Angular frequency in radians per second, derived from cyclic frequency
 *   $\omega = 2\pi f$, where $f = \text{dayOfMonth} / 3600\text{ Hz}$ (`HERO_CODE_F`).
