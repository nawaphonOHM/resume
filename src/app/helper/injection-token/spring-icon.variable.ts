...
} from '../interface/brand-logo/technology-icon-meta-data/technology-icon-meta-data.interface.ts';
...
export const SPRING_ICON = new InjectionToken<TechnologyIconMetadata>(
  'SPRING_ICON',
  {
    providedIn: 'root',
    factory: () => {
