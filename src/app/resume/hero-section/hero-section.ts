 ...
 *      - Left: $\theta_{\text{left}}(t) = \omega(f \cdot (r_{\text{right}} / r_{\text{left}})) \cdot t + \phi_{\text{left}}$, $x_{\text{left}}(t) = r_{\text{left}} A \cos(\theta_{\text{left}}(t))$, $y_{\text{left}}(t) = r_{\text{left}} A \sin(\theta_{\text{left}}(t))$
 *      - Right: $\theta_{\text{right}}(t) = \omega(f) \cdot t + \phi_{\text{right}}$, $x_{\text{right}}(t) = r_{\text{right}} A \cos(\theta_{\text{right}}(t))$, $y_{\text{right}}(t) = r_{\text{right}} A \sin(\theta_{\text{right}}(t))$
 *
