...
| `src/app/resume/hero-section/hero-section.spec.ts`                                                                             | Dual-rate loop coordination: 1 Hz Bangkok clock ticker, 60/120 Hz orbital kinematics, and reduced-motion clamping.        |
